...
public class Area4Spawning : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        scoreManagerBlue.BlueScore4 = logisticsCap;
    }
    ...
    public void DespawnLast()
    {
        ...
        if (scoreManagerBlue.BlueScore4 < logisticsCap)
        {
